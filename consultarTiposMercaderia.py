    ...
    try:
        ...
        with open(iniciar['entrada'],"r") as archivo:
            for linea in archivo:
                cuitTitula = linea
        resultado = iniciar['cliente'].service.consultarTiposMercaderia(authRequest={'token': iniciar['token'], 'sign': iniciar['sign'], 'cuitRepresentada': iniciar['cuitRepresentada']})
        print(resultado)
